...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { article_id: @mark.article_id, user_id: @mark.user_id, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { article_id: @mark.article_id, user_id: @mark.user_id, value: @mark.value } }
